...
public struct Config {
    ...
    public static let currentUserEmailKey: String = "currentUserEmailKey"
    ...
    public static let registrationEmailCodeKey: String = "registrationEmailCodeKey"
    ...
    public static let registrationEmailNextRetryKey: String = "registrationEmailNextRetryKey"
