...
*/
    ...
    public struct UserProfileAccountmetaArgs: Encodable {
        ...
        // MARK: - Initialization
        init(type: String, app: String, email: String, phone: String, facebook: String, instagram: String, telegram: String, vk: String, website: String, firstName: String,  lastName: String, name: String, birthDate: String, gender: String, location: String, city: String, about: String, occupation: String, iCan: String, lookingFor: String, businessCategory: String, backgroundImage: String, coverImage: String, profileImage: String, userImage: String, icoAddress: String, targetDate: String, targetPlan: String, targetPointA: String, targetPointB: String) {
            self.type               =   type
            self.app                =   app
            self.email              =   email
            self.phone              =   phone
            ...
            self.business_category  =   businessCategory
            self.background_image   =   backgroundImage
            self.cover_image        =   coverImage
            self.profile_image      =   profileImage
            self.user_image         =   userImage
            self.ico_address        =   icoAddress
            self.target_date        =   targetDate
            self.target_plan        =   targetPlan
            self.target_point_a     =   targetPointA
            self.target_point_b     =   targetPointB
        }
    }
